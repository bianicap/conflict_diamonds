...
public class ConflictDiamondsBuilder {	
     ...
     *
     */
    static public void create(String regionfile, String remotenessfile, String diamondfile, String diamondproximatefile, String populationfile, ConflictDiamonds conflictDiamonds) {					
        try {
            // Open the file
           FileInputStream fstreamregion = new FileInputStream(regionfile);
           FileInputStream fstreamremote = new FileInputStream(remotenessfile);
           FileInputStream fstreamdiamonds = new FileInputStream(diamondfile);
           FileInputStream fstreamdiamondsproximate = new FileInputStream(diamondproximatefile);
           FileInputStream fstreampopulation = new FileInputStream(populationfile);
			   
           // Convert our input stream to a BufferedReader
           BufferedReader regionarea = new BufferedReader(new InputStreamReader(fstreamregion));
           BufferedReader remotesurface = new BufferedReader(new InputStreamReader(fstreamremote));
           BufferedReader diamondsurface = new BufferedReader(new InputStreamReader(fstreamdiamonds));
           BufferedReader diamondproximatesurface = new BufferedReader(new InputStreamReader(fstreamdiamondsproximate));
           BufferedReader populationdist = new BufferedReader(new InputStreamReader(fstreampopulation));
           ...
           for (int i = 0; i < numRegions; i++) {
            ...
            File file=new File("src/conflictdiamonds/z_boundaries.shp");
            URL boundariesShapeUL = file.toURL();
            ...
            File fileDiamonds = new File("src/conflictdiamonds/z_Diamond_SL.shp");
            URL diamondsShapeUL = fileDiamonds.toURL();
